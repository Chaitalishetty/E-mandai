...
<body>
    ...
    <div class="row" id="product-section">
        <?php
            ...
            $query = " SELECT * FROM `orders` WHERE providername='$farm'";
        ...
        <div class="col-sm-3" style="display:flex;justify-content:center">
           <form method="POST" action="addcart.php">
            <input type="hidden" name="pid" value="<?php echo $row['productid'];?>"><br>
            <input type="hidden" name="pname" value="<?php echo  $row['productname'];?>" ><br>
            <input type="hidden" name="pprice" value="<?php echo  $row['productprice'];?>" >
            <input type="hidden" name="pimg" value="<?php echo  $row['productimage'];?>" >
            <input type="hidden" name="pquan" value="<?php echo  $row['productquantity'];?>" >
            <div class="product_card">
                <div class="card text-center" style="width: 18rem;">
                <img src="<?php echo $row['productimage'];?>" class="card-img-top" width="auto" height="250px" alt="product-image">
                <div class="card-body">
                    <h5 class="card-title">
                    <div class="card-title1"><?php echo strtoupper($row['productname']);?>
                    </div>
                    </a>
                    <div><?php echo  $row['productquantity'];?></div>
                    &nbsp;&nbsp;<div class="card-title2">&#x20b9;<?php echo $row['productprice'];?></div>
                    </h5>
                    <h5>
                    Customer details:
                    <div class="card-title1">Name: <?php echo $row['customername'];?></div>
                    <div class="card-title1">Phone number: <?php echo $row['customerphone'];?></div>
                    <div class="card-title1">Address: <?php echo $row['customeraddress'];?></div>
                    </h5>
                </div>
                </div>
            </div>
